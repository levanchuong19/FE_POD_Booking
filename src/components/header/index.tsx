...
function Header() {
  ...
  return (
    <div className="header">
        ...
        <UserOutlined onClick={handleUserIconClick} className="user" style={{fontSize: 35}}/>
        </div>
        {isModalVisible && (
                <Modal title="User Profile" visible={isModalVisible} onCancel={handleModalClose} footer={null}>
                    {UserData ? (
                        <Form
                            labelCol={{ span: 8 }}
                            wrapperCol={{ span: 16 }}
